...
pub enum PSEL_A {
    ...
    ANALOGINPUT6 = 6,
    #[doc = "7: VDD/2 selected as analog input"]
    VDDDIV2 = 7,
}
...
impl PSEL_R {
    ...
    #[doc = "Checks if the value of the field is `VDDDIV2`"]
    #[inline(always)]
    pub fn is_vdd_div2(&self) -> bool {
        *self == PSEL_A::VDDDIV2
    }
}
...
impl<'a> PSEL_W<'a> {
    ...
    #[inline(always)]
    pub fn vdd_div2(self) -> &'a mut W {
        self.variant(PSEL_A::VDDDIV2)
    }
